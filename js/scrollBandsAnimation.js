...
const observer3 = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    ...
    if (entry.isIntersecting) {
      band1.classList.add('bands1');
      observer3.unobserve(entry.target); // Przestaje obserwować element po dodaniu klasy
      return; // Jeśli dodano klasę, opuść funkcję
    }

    // Nie ma przecięcia, więc usuń klasę!
    band1.classList.remove('bands1');
  });
});
...
const observer4 = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    ...
    if (entry.isIntersecting) {
      band2.classList.add('bands2');
      observer4.unobserve(entry.target); // Przestaje obserwować element po dodaniu klasy
      return; // Jeśli dodano klasę, opuść funkcję
    }
...
const observer5 = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    ...
    if (entry.isIntersecting) {
      band3.classList.add('bands3');
      observer5.unobserve(entry.target); // Przestaje obserwować element po dodaniu klasy
      return; // Jeśli dodano klasę, opuść funkcję
    }
...
const observer6 = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    ...
    if (entry.isIntersecting) {
      band1mobile.classList.add('bands1mobile');
      observer6.unobserve(entry.target); // Przestaje obserwować element po dodaniu klasy
      return; // Jeśli dodano klasę, opuść funkcję
    }
...
const observer7 = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    ...
    if (entry.isIntersecting) {
      band2mobile.classList.add('bands2mobile');
      observer7.unobserve(entry.target); // Przestaje obserwować element po dodaniu klasy
      return; // Jeśli dodano klasę, opuść funkcję
    }
...
const observer8 = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    ...
    if (entry.isIntersecting) {
      band3mobile.classList.add('bands3mobile');
      observer8.unobserve(entry.target); // Przestaje obserwować element po dodaniu klasy
      return; // Jeśli dodano klasę, opuść funkcję
    }
